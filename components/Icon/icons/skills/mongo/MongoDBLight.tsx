export const MongoDBLight: React.FC = () => {
  return (
    <g fill="none">
      <g filter="url(#mondol_a)">
        <circle cx="108" cy="105" r="91" fill="#FBFBFB" />
      </g>
      <g clipPath="url(#mondol_b)">
        <path
      ...
      <defs>
        ...
        >
          ...
          <feMorphology
            ...
            operator="dilate"
            in="SourceAlpha"
            result="effect1_dropShadow_325_50"
          />
          <feOffset dy="3" />
          ...
          <feBlend in2="shape" result="effect2_innerShadow_325_50" />
        </filter>
      </defs>
    </g>
  );
