  ...
  return (
    <div style={{ position: 'relative', zIndex: 10 }}>
      ...
      <div className="intro-text">
        <h1>Hello World, I'm<br /><span id="myName">Albert-Andrei Moldovanu</span></h1>
      ...
      <div className='paralax-text'>
        <h2 style={{ transform: `translateX(${offsetY * 0.5}px)` }}>Personal</h2>
        {/* <h2 style={{ left: offsetY * 0.5 + 'px' }}>Personal</h2> */}
        <h2 style={{ transform: `translateX(${-offsetY * 0.5}px)` }}>projects</h2>
      </div>
      <a name="projects" />
      <Projects />
      <STitle />
